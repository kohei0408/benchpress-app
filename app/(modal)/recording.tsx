        ...
        >
          ...
          <View className="mt-4 rounded-lg border border-lift/20 bg-ink p-4">
            ...
            <View className="flex-row items-center">
              <TouchableOpacity
                accessibilityRole="button"
                className="h-14 w-14 items-center justify-center rounded-lg bg-white/10"
              ...
              <Text className="mx-4 flex-1 text-center text-5xl font-black text-white">{currentSet.reps}</Text>
              <TouchableOpacity
                accessibilityRole="button"
            ...
            <View className="mt-3 flex-row">
              <TouchableOpacity
                ...
                className={`mr-2 h-14 flex-1 items-center justify-center rounded-lg ${
                  canGoNext ? "bg-white/10" : "bg-white/5"
                }`}
                disabled={!canGoNext}
                onPress={nextSet}
              >
